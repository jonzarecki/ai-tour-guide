...
f_res_500 = [(r['name'], r['plus_code']['compound_code'][8:], r['user_ratings_total']) for r in results_500 if r.get('user_ratings_total', 0) > 500]
f_res_1000 = [(r['name'], r['plus_code']['compound_code'][8:], r['user_ratings_total']) for r in results_1000 if r.get('user_ratings_total', 0) > 500]
query = f"You're a helpful and informative chatbot. You like talking about history and the location you clients are. \n" \
